...
<html>
	...
	<body class="subpage">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="#">Kali<span> lugares</span></a></h1>
				<a href="#menu">Menú</a>
			</header>
				...
				<section class="wrapper ">
					<div class="inner">
						<header class="align-center">
							<h2>Podrás encontrar algunos de estos lugares de interés:</h2>
							<p>Se muestran los lugares más cercanos a tu posición.</p>
						</header>
						...
						<!-- 3 Column Video Section -->
							<div class="flex flex-3">
								...
								<div class="video col">
									...
									<a href="login" class="link"><span>Click Me</span></a>
								</div>
								<div class="video col">
									<div class="image fit">
